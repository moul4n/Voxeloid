...
`stacking-and-scaling.html` (the buff system research). `docs/README.md` says which
parts of the older three have been overtaken by the design doc.
...
docs/       the four design documents, offline copies (start with voxeloid-design)
